...
template <typename Key, typename T>
struct My::details::custom_type_name<std::pmr::unordered_map<Key, T>> {
  static constexpr auto get() noexcept {
...
template <typename Key, typename T, typename Hash, typename KeyEqual>
struct My::details::custom_type_name<
    std::pmr::unordered_map<Key, T, Hash, KeyEqual>> {
  static constexpr auto get() noexcept {
    return concat_seq(TSTR("std::pmr::unordered_map<{"), type_name<Key>(),
                      TStr_of_a<','>{}, type_name<T>(), TStr_of_a<','>{},
                      type_name<Hash>(), TStr_of_a<','>{},
...
template <typename Key, typename T, typename Hash>
struct My::details::custom_type_name<
    std::pmr::unordered_multimap<Key, T, Hash>> {
  static constexpr auto get() noexcept {
    return concat_seq(TSTR("std::pmr::unordered_multimap<{"), type_name<Key>(),
                      TStr_of_a<','>{}, type_name<T>(), TStr_of_a<','>{},
                      type_name<Hash>(), TStrC_of<'}', '>'>{});
...
template <typename Key, typename T, typename Hash, typename KeyEqual>
struct My::details::custom_type_name<
    std::pmr::unordered_multimap<Key, T, Hash, KeyEqual>> {
  static constexpr auto get() noexcept {
    return concat_seq(TSTR("std::pmr::unordered_multimap<{"), type_name<Key>(),
                      TStr_of_a<','>{}, type_name<T>(), TStr_of_a<','>{},
                      type_name<Hash>(), TStr_of_a<','>{},
