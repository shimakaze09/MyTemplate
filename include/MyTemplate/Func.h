...
struct FuncTraits<Ret(Args...)>
    : FuncTraitsBase<false, false, ReferenceMode::NONE, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1000
struct FuncTraits<Ret(Args...) const>
    : FuncTraitsBase<true, false, ReferenceMode::NONE, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0100
struct FuncTraits<Ret(Args...) volatile>
    : FuncTraitsBase<false, true, ReferenceMode::NONE, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1100
struct FuncTraits<Ret(Args...) const volatile>
    : FuncTraitsBase<true, true, ReferenceMode::NONE, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0010
struct FuncTraits<Ret(Args...)&>
    : FuncTraitsBase<false, false, ReferenceMode::LEFT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1010
struct FuncTraits<Ret(Args...) const&>
    : FuncTraitsBase<true, false, ReferenceMode::LEFT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0110
struct FuncTraits<Ret(Args...) volatile&>
    : FuncTraitsBase<false, true, ReferenceMode::LEFT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1110
struct FuncTraits<Ret(Args...) const volatile&>
    : FuncTraitsBase<true, true, ReferenceMode::LEFT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0020
struct FuncTraits<Ret(Args...) &&>
    : FuncTraitsBase<false, false, ReferenceMode::RIGHT, false, Ret(Args...)> {
};

template <typename Ret, typename... Args>  // 1020
struct FuncTraits<Ret(Args...) const&&>
    : FuncTraitsBase<true, false, ReferenceMode::RIGHT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0120
struct FuncTraits<Ret(Args...) volatile&&>
    : FuncTraitsBase<false, true, ReferenceMode::RIGHT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1120
struct FuncTraits<Ret(Args...) const volatile&&>
    : FuncTraitsBase<true, true, ReferenceMode::RIGHT, false, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0001
struct FuncTraits<Ret(Args...) noexcept>
    : FuncTraitsBase<false, false, ReferenceMode::NONE, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1001
struct FuncTraits<Ret(Args...) const noexcept>
    : FuncTraitsBase<true, false, ReferenceMode::NONE, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0101
struct FuncTraits<Ret(Args...) volatile noexcept>
    : FuncTraitsBase<false, true, ReferenceMode::NONE, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1101
struct FuncTraits<Ret(Args...) const volatile noexcept>
    : FuncTraitsBase<true, true, ReferenceMode::NONE, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0011
struct FuncTraits<Ret(Args...) & noexcept>
    : FuncTraitsBase<false, false, ReferenceMode::LEFT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1011
struct FuncTraits<Ret(Args...) const & noexcept>
    : FuncTraitsBase<true, false, ReferenceMode::LEFT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0111
struct FuncTraits<Ret(Args...) volatile & noexcept>
    : FuncTraitsBase<false, true, ReferenceMode::LEFT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1111
struct FuncTraits<Ret(Args...) const volatile & noexcept>
    : FuncTraitsBase<true, true, ReferenceMode::LEFT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0021
struct FuncTraits<Ret(Args...) && noexcept>
    : FuncTraitsBase<false, false, ReferenceMode::RIGHT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1021
struct FuncTraits<Ret(Args...) const && noexcept>
    : FuncTraitsBase<true, false, ReferenceMode::RIGHT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 0121
struct FuncTraits<Ret(Args...) volatile && noexcept>
    : FuncTraitsBase<false, true, ReferenceMode::RIGHT, true, Ret(Args...)> {};

template <typename Ret, typename... Args>  // 1121
struct FuncTraits<Ret(Args...) const volatile && noexcept>
    : FuncTraitsBase<true, true, ReferenceMode::RIGHT, true, Ret(Args...)> {};
