...
constexpr size_t string_hash_seed(size_t seed, const char* str,
                                  size_t N) noexcept;

constexpr size_t string_hash_seed(size_t seed, std::string_view str) noexcept {
  return string_hash_seed(seed, str.data(), str.size());
}

template <size_t N>
constexpr size_t string_hash_seed(size_t seed, const char (&str)[N]) noexcept {
