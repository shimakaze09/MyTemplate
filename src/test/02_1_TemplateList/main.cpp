...
#include <MyTemplate/List/TemplateList.h>
...
int main() {
  ...
  cout << "list0" << endl << "\t" << Name<list0>() << endl;
  ...
  cout << "TConcat_t<list0, TemplateList<A,D>>" << endl
       << "\t" << Name<TConcat_t<list0, TemplateList<TypeList<void>, A, D>>>()
       << endl;
  cout << "TAccumulateIS_t<list0, ToI, TemplateList<D>, 0, 2>" << endl
       << "\t"
       << Name<TAccumulateIS_t<list0, ToI, TemplateList<TypeList<void>, D>, 0,
                               2>>()
       << endl;
  ...
  cout << "TContain<list0, B>" << endl << "\t" << TContain_v<list0, B> << endl;
  cout << "TContain<list0, D>" << endl << "\t" << TContain_v<list0, D> << endl;
