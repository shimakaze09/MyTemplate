...
template <typename Base>
struct EBCODerived1 : EBCO<EBCOEmpty1>::type<Base> {
  char c;
};
...
template <typename Base>
struct EBCODerived2 : EBCO<EBCOEmpty2>::type<Base> {
  char c;
};
...
template <typename Base>
struct EBCODerived3 : EBCO<EBCOEmpty2, EBCOEmpty3>::type<Base> {
  char c;
};

template <typename Base>
struct EBCODerived4 : EBCO<EBCOEmpty2, EBCOEmpty3>::type<Base> {
  int c;
};
...
struct EBCOIFoo : Base {
  Impl& Foo() { return *static_cast<Impl*>(this); }
};
...
int main() {
  cout << "1 : " << sizeof(Empty1) << " " << sizeof(EBCOEmpty1<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Struct1) << " " << sizeof(EBCOStruct1<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Derived1) << " " << sizeof(EBCODerived1<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Empty2) << " " << sizeof(EBCOEmpty2<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Derived2) << " " << sizeof(EBCODerived2<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Derived3) << " " << sizeof(EBCODerived3<EBCONil>)
       << endl;
  cout << "4 : " << sizeof(Derived4) << " " << sizeof(EBCODerived4<EBCONil>)
       << endl;
  cout << "1 : " << sizeof(Struct2) << " " << sizeof(EBCOStruct2<EBCONil>)
       << endl;
  Struct2 s2;
