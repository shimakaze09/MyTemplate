...
int main() {
  {  // basic
    ...
    std::cout << "|" << type_name<const volatile A<2, int>* const&>().View()
              << "|" << std::endl;
    std::cout << "|" << type_name<decltype(&f)>().View() << "|" << std::endl;
    std::cout << "|" << type_name<decltype(&C<float>::f)>().View() << "|"
              << std::endl;
    std::cout << "|" << type_name<C<decltype(&C<float>::f)>::D>().View() << "|"
              << std::endl;
    std::cout << "|" << type_name<decltype(&C<A<2, int>>::g)>().View() << "|"
              << std::endl;
    std::cout << "|" << type_name<A<2, int>[][8]>().View() << "|" << std::endl;
    std::cout << "|"
              << type_name<const AA<A<-2, int>, 2, 4, 5, 126>* const&>().View()
              << "|" << std::endl;
  }
  {  // to_typename_template_type
    ...
    std::cout << "|" << type_name<B1<&BH::f>>().View() << "|"
              << std::endl;  // 1...
    std::cout << "|" << type_name<B2<&BH::f, &BH::f, &BH::f, &BH::f>>().View()
              << "|" << std::endl;  // 1...
    std::cout << "|" << type_name<B3<&BH::f, &BH::f>>().View() << "|"
              << std::endl;  // 1 1
    std::cout << "|" << type_name<B3_1<&BH::f, &BH::f, &BH::f>>().View() << "|"
              << std::endl;  // 1...
    std::cout << "|" << type_name<B4<&BH::f, &BH::f>>().View() << "|"
              << std::endl;  // 1 1
    std::cout << "|" << type_name<B4_1<1, &BH::f, &BH::f>>().View() << "|"
              << std::endl;  // 1 1 1
    std::cout << "|" << type_name<B4_2<&BH::f, &BH::f, &BH::f, &BH::f>>().View()
              << "|" << std::endl;  // 1...
    std::cout << "|" << type_name<B4_3<1, &BH::f, &BH::f, &BH::f>>().View()
              << "|" << std::endl;  // 1...
    std::cout << "|" << type_name<B5<&BH::f>>().View() << "|"
              << std::endl;  // 1...

    std::cout << "|" << type_name<B6<&BH::f, decltype(&BH::f)>>().View() << "|"
              << std::endl;  // 1 0

    std::cout << "|" << type_name<B7<&BH::f, decltype(&BH::f)>>().View() << "|"
              << std::endl;  // 1 0...
    std::cout
        << "|"
        << type_name<B7<&BH::f, decltype(&BH::f), decltype(&BH::f)>>().View()
        << "|" << std::endl;  // 1 0...

    std::cout << "|" << type_name<B8<decltype(&BH::f), &BH::f>>().View() << "|"
              << std::endl;  // 0 1
    std::cout << "|" << type_name<B9<decltype(&BH::f), &BH::f, &BH::f>>().View()
              << "|" << std::endl;  // 0 1 1
    std::cout << "|"
              << type_name<B9_1<decltype(&BH::f), &BH::f, &BH::f>>().View()
              << "|" << std::endl;  // 0 1 1
    std::cout
        << "|"
        << type_name<B10<decltype(&BH::f), &BH::f, &BH::f, &BH::f>>().View()
        << "|" << std::endl;  // 0 1...
    std::cout
        << "|"
        << type_name<B11<&BH::f, decltype(&BH::f), decltype(&BH::f)>>().View()
        << "|" << std::endl;  // 1 0 0
