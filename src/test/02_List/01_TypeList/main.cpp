...
int main() {
  ...
  cout << "Find_v<list0, float>: " << Find_v<list0, float> << endl;
  ...
  cout << ExistInstance_v<TypeList<bool, TypeList<TypeList<bool>>, int>,
                          TypeList> << endl;
  cout << Name<SearchInstance_t<TypeList<bool, TypeList<TypeList<bool>>, int>,
                                TypeList>>()
       << endl;
