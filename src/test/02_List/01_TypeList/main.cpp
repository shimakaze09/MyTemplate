...
int main() {
  ...
  static_assert(
      is_same_v<PushFront_t<list, double>, TypeList<double, int, float, bool>>);
  static_assert(
      is_same_v<PushBack_t<list, double>, TypeList<int, float, bool, double>>);
  ...
  static_assert(is_same_v<Concat_t<list, TypeList<char, double>>,
