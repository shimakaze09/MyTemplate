...
template <typename Base>
struct IDerived1 : SIN<IEmpty1>::Ttype<Base> {
  char c;
};
...
template <typename Base>
struct IDerived2 : SIN<IEmpty2>::Ttype<Base> {
  char c;
};
...
template <typename Base>
struct IDerived3 : SIN<IEmpty2, IEmpty3>::Ttype<Base> {
  char c;
};
...
template <typename Base>
struct IDerived4 : SIN<IEmpty2, IEmpty3>::Ttype<Base> {
  int c;
};
