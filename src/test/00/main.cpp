...
struct AccumulateT {
  using type = typename AccumulateT<Tail<List>, Op,
                                    typename Op<I, Head<List>>::type>::type;
};
template <typename List, template <typename I, typename X> class Op, typename I>
...
template <typename T>
struct NameTraits {
  static constexpr const char* text = "ERROR";
};

template <>
struct NameTraits<void> {
  static constexpr const char* text = "void";
};

template <>
struct NameTraits<bool> {
  static constexpr const char* text = "bool";
};

template <>
struct NameTraits<char> {
  static constexpr const char* text = "char";
};

template <>
struct NameTraits<short> {
  static constexpr const char* text = "short";
};

template <>
struct NameTraits<int> {
  static constexpr const char* text = "int";
};

template <>
struct NameTraits<long> {
  static constexpr const char* text = "long";
};

template <>
struct NameTraits<long long> {
  static constexpr const char* text = "long long";
};

template <>
struct NameTraits<float> {
  static constexpr const char* text = "float";
};

template <>
struct NameTraits<double> {
  static constexpr const char* text = "double";
};

template <>
struct NameTraits<nullptr_t> {
...
struct Name<Typelist<>> {
  friend ostream& operator<<(ostream& os, Name<Typelist<>> n) { return os; }
};
