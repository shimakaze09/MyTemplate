...
template <typename Base>
struct SIDerived1 : SI<SIEmpty1>::type<Base> {
  char c;
};
...
template <typename Base>
struct SIDerived2 : SI<SIEmpty2>::type<Base> {
  char c;
};
...
template <typename Base>
struct SIDerived3 : SI<SIEmpty2, SIEmpty3>::type<Base> {
  char c;
};

template <typename Base>
struct SIDerived4 : SI<SIEmpty2, SIEmpty3>::type<Base> {
  int c;
};
...
int main() {
  ...
  cout << "1 : " << sizeof(Derived1) << " " << sizeof(SIDerived1<SINil>)
       << endl;
  cout << "1 : " << sizeof(Empty2) << " " << sizeof(SIEmpty2<SINil>) << endl;
  cout << "1 : " << sizeof(Derived2) << " " << sizeof(SIDerived2<SINil>)
       << endl;
  cout << "1 : " << sizeof(Derived3) << " " << sizeof(SIDerived3<SINil>)
       << endl;
  cout << "4 : " << sizeof(Derived4) << " " << sizeof(SIDerived4<SINil>)
       << endl;
